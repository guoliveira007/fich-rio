CREATE TABLE public.import_claims (
...
INSERT INTO public.import_claims (legacy_user_id, code)
VALUES ('72c13b72-acb3-45a7-bc84-ed076453484a', 'FICHARIO-2026');

CREATE OR REPLACE FUNCTION public.claim_imported_data(_code text)
RETURNS text
LANGUAGE plpgsql
SECURITY DEFINER
...
REVOKE ALL ON FUNCTION public.claim_imported_data(text) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.claim_imported_data(text) TO authenticated;